...
grub_target_cppflags='-Wno-unused-but-set-variable -Wall -W  -DGRUB_MACHINE_EFI=1 -DGRUB_MACHINE=I386_EFI -m32 -nostdinc -isystem /usr/lib/gcc/i686-linux-gnu/14/include -I$(top_srcdir)/include -I$(top_builddir)/include'
